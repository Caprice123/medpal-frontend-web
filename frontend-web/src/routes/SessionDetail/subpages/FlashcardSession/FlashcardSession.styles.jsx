...
export const Tag = styled.span`
  background: ${props => props.type === 'university' ? 'rgba(99, 102, 241, 0.1)' : props.type === 'semester' ? 'rgba(16, 185, 129, 0.1)' : props.type === 'status' ? 'rgba(6, 182, 212, 0.1)' : props.type === 'score' ? 'rgba(6, 182, 212, 0.1)' : 'rgba(107, 114, 128, 0.1)'};
  color: ${props => props.type === 'university' ? '#6366f1' : props.type === 'semester' ? '#10b981' : props.type === 'status' ? '#06b6d4' : props.type === 'score' ? '#06b6d4' : '#374151'};
