...
export const useFeatureSetting = (onClose) => {
  ...
  const form = useFormik({
    initialValues: {
      ...
      chatbot_normal_system_prompt: 'Kamu adalah asisten AI medis yang membantu mahasiswa kedokteran dan profesional kesehatan. Berikan jawaban yang informatif, akurat, dan mudah dipahami.',
